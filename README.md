...
Dieses Projekt enthält drei Versionen der Edusol-Website zum Vergleich.
...
- **Wirkungsfelder-Seiten** mit Hero, Inhaltstext, Feature-Karten und CTA-Kasten („Wir erstellen euch gerne ein individuelles Angebot." → Link zum Kontaktformular)
- **Über uns** (`ueber-uns.html`) mit Titel „Das sind wir" und zwei Inhaltssektionen
